...
\begin{figure}
\centering
\includegraphics[width=0.48\linewidth]{images/classAbstractNode__coll__graph}
...
\begin{figure}
\centering
\includegraphics[width=\linewidth,height=1.35\columnwidth]{images/classAbstractNode__inherit__graph}
