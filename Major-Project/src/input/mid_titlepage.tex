...
{Submitted By:}\\
\textnormal{{\fontsize{14}{13}\selectfont Amarjeet Singh Kapoor (1311017)\\ Govind Sharma (1311053) \\ }} % Your name
\end{flushleft}
\end{minipage}
~
\begin{minipage}{0.4\textwidth}
	\begin{flushleft} \large
		{Submitted To:}\\
		\textnormal{{\fontsize{14}{13}\selectfont Prof. Amanpreet Singh Brar \\ Associate Professor \\ }} % Your name
	\end{flushleft}
\end{minipage}\\[1.4cm]
